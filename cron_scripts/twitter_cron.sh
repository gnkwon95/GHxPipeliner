...
/home/ubuntu/GHxPipeliner/cron/test_subcron.sh $ts_nodash $token $aws_access_key_id $aws_secret_access_key

#/home/ubuntu/GHxPipeliner/cron/raw_twitter_hourly_cron.sh $ts_nodash $token $aws_access_key_id $aws_secret_access_key

/home/ubuntu/GHxPipeliner/cron/raw_twitter_hourly_cron.sh $ts_nodash $token $aws_access_key_id $aws_secret_access_key  > /home/ubuntu/GHxPipeliner/log/twitter_cron.txt 2>&1
