...
def main():
    ...
    s3.upload_file('/home/ubuntu/shlee/tmp/twits.csv', bucket_name, f"hourly_twits/{startTimeFormatted[:15]}.csv")
    s3.upload_file('/home/ubuntu/shlee/tmp/counts.csv', bucket_name, f"hourly_twit_counts/{startTimeFormatted[:15]}.csv")
